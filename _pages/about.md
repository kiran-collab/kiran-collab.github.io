...
Currently, I am working with [Rahul Garg]() on optimizing wakeword detection algorithms for largescale robotic tasks and [Narayanan Nagarajan]() on developing agentic workflows for automatic RFI resolutions in a 2D to 3D construction CAD image -> video visualizer.
