...
.wordcloud span { display: inline-block; margin: 0 0.42em; white-space: nowrap; font-weight: 600; letter-spacing: -0.01em; }
...
.wc-a { color: #b83227; } .wc-b { color: #1f6f8b; } .wc-c { color: #4a6741; }
.wc-d { color: #6b4a8b; } .wc-e { color: #8a6d1f; } .wc-f { color: #555f6b; }

/* ---------- entry layout ---------- */
.tk-item { display: flex; gap: 1.4em; align-items: flex-start; margin: 0 0 1.9em; flex-wrap: wrap; }
...
<h2 class="tk-sec">Model Optimization and Efficient Inference</h2>
...
<h2 class="tk-sec">Agentic AI and LLM Systems</h2>
...
<h2 class="tk-sec">Retrieval and Vector Search</h2>
...
<h2 class="tk-sec">Evaluation, Reliability, and Learning</h2>
...
<h2 class="tk-sec">Machine Learning and Statistical Modelling</h2>
...
<h2 class="tk-sec">Data Engineering and Databases</h2>
...
<h2 class="tk-sec">Backend, APIs, and Integration</h2>
...
<h2 class="tk-sec">Platform, Infrastructure, and MLOps</h2>
...
<h2 class="tk-sec">Security and Access</h2>
...
<h2 class="tk-sec">Languages and Core Tooling</h2>
